...
#for python 3 users you can use the statistics package
#from statistics import mode
#for python 2.7 use the scipy package :
...
class VoteClassifier(ClassifierI):
    ...
    def classify(self, features):
        ...
        for c in self._classifiers:
            ...
            votes.append(v)
        return stats.mode(votes) #python 2.7 use: stats.mode(votes)
    ...
    def confidence(self, features):
        ...
        for c in self._classifiers:
            v = c.classify(features)
            votes.append(v)
        #python3+ choice_votes = votes.count(mode(votes))
